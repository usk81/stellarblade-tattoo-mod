# Womb Tattoo mod for Stellar Blade
...
e.g. Crimson Wings (tatoo type 01 / all tattoos / black) :

```
womb_V3_All_A01_Black_429_P
```

e.g. White Kunoichi (tattoo type 02 / abdomen only / pink):

```
womb_V1_AbdomenOnly_A02_Pink_429_P
```
...
|Name|reference body type|base skin texture (detail)|upper_arm|clavicle|abdomen|under construction|note|ID|Name (Japanese)|
|:----|:----|:----|:----|:----|:----|:----|:----|:----|:----|
...
|Planet Diving Suit (7th)|(Unsupported)|CH_P_EVE_09_Skin| | | |✓| |CH_P_EVE_09|プラネットダイブスーツ（第7）|
|Planet Diving Suit (7th) V2|(Unsupported)|CH_P_EVE_09_Skin| | | |✓| |CH_P_EVE_09_TypeB|プラネットダイブスーツ（第7）V2|
|Planet Diving Suit (7th) V3|(Unsupported)|CH_P_EVE_09_Skin| | | |✓| |CH_P_EVE_09_TypeC|プラネットダイブスーツ（第7）V3|
